...
class MakeTimeOptimalAcceptingTrace(frontend.Application):
    def __init__(self):
        cmd = 'make_time_optimal_accepting_trace'
        desc = 'Compute time optimal Accepting Trace.'
    ...
    def main(self, args):
        frontend.make_time_optimal_accepting_trace_setup(args['comp_names'],
                                                         args['steps'])
...
if __name__ == '__main__':
    app = MakeTimeOptimalAcceptingTrace()

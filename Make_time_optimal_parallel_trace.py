...
class Make_time_optimal_parallel_trace(frontend.Application):
    def __init__(self):
    ...
    def main(self, args):
        weighted_frontend.make_time_optimal_accepting_trace_weighted_random(args['comp_names'],
                                        args['req_names'],
                                        args['steps'])

if __name__ == '__main__':
    app = Make_time_optimal_parallel_trace()
    app.run()

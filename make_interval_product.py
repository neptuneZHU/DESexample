...
from automata import interval_structure, frontend

class MakeIntervalProductApplication(frontend.Application):
    def __init__(self):
        cmd = 'make_product'
    ...
    def main(self, args):
        interval_structure.make_interval_product(args['aut_names'], args['product_name'])

if __name__ == '__main__':
    app = MakeIntervalProductApplication()
    app.run()

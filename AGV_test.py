...
sys.path.insert(0, '/Users/linglin/PycharmProjects/drag_and_play_power/SuSyNA')
...
files = [x for x in os.listdir('/Users/linglin/PycharmProjects/drag_and_play_power') if x[-3:] == 'cfg']
plant_string = ''
for entry in files:
...
#for file in files:
#    print(file[:-4])
#    frontend.make_dot('/Users/linglin/PycharmProjects/drag_and_play_power/' + file, file[:-4] + '.dot')

    #os.system('dot -Tpng '+ file[:-4]+'.dot'+ ' > ' + file[:-4]+ '.png')
